...
@Component({
  selector: 'app-prescolaire-page',
  templateUrl: './prescolaire-page.component.html',
  styleUrls: ['./prescolaire-page.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PrescolairePageComponent implements OnInit {
